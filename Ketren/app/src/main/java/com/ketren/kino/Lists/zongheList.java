...
public class zongheList
{
    ...
    public zongheList(String KinoNami,String kinoRasimi,String KinoTili,String KinoKoyulixi,String KinoID,String KinoQuxandurulixi,String vip) {
        this.vip=vip;
