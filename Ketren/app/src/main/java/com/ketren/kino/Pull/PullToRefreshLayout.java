...
import com.ketren.kino.Pull.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	public void refreshFinish(int refreshResult)
	{
		...
		{
			case SUCCEED:
				refreshStateTextView.setText("يىڭىلاش تامام");
				break;
			case FAIL:
			default:
				refreshStateTextView.setText("يىڭىلاش مەغلۇپ بولدى");
				break;
		}
		if (pullDownY > 0)
		{
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		switch (refreshResult)
		{
			case SUCCEED:
				// 加载成功
				loadStateTextView.setText("قوشۇش تامام");
				break;
			case FAIL:
			default:
				// 加载失败
				loadStateTextView.setText("قوشۇش مەغلۇپ بولدى");
				break;
		}
		if (pullUpY < 0)
		{
	...
	private void changeState(int to)
	{
		...
		switch (state)
		{
			case INIT:
				// 下拉布局初始状态
				refreshStateTextView.setText("ئاستىغا تارتىپ يىڭىلاڭ");
				// 上拉布局初始状态
				loadStateTextView.setText("ئۈستىگە تارتىپ يىڭىلاڭ");
				break;
			case RELEASE_TO_REFRESH:
				// 释放刷新状态
				refreshStateTextView.setText("قويۇپ بېرىپ يىڭىلاڭ");
				break;
			case REFRESHING:
				// 正在刷新状态
				refreshingView.setVisibility(View.VISIBLE);
				refreshStateTextView.setText("يىڭىلىنىۋاتىدۇ…");
				break;
			case RELEASE_TO_LOAD:
				// 释放加载状态
				loadStateTextView.setText("قويۇپ بېرىپ كۆپ مەزمۇنغا ئىرىشىڭ");
				
				break;
			case LOADING:
				// 正在加载状态
				loadingView.setVisibility(View.VISIBLE);
	     		loadStateTextView.setText("قوشىلىۋاتىدۇ…");
				break;
			case DONE:
				// 刷新或加载完毕，啥都不做
				break;
