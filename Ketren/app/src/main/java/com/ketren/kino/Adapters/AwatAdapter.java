 ...
 */
public class AwatAdapter extends RecyclerView.Adapter<AwatAdapter.ViewHolder> {
	static ArrayList<AwatList> msgList;
	private Context c;
	public AwatAdapter(ArrayList<AwatList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public AwatAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
