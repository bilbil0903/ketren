...
public class TawsiyaList
{
	...
	private String vip;
    public TawsiyaList(String KinoNami,String kinoRasimi,String KinoTili,String KinoKoyulixi,String KinoID,String KinoQuxandurulixi,String vip) {
        this.vip = vip;
