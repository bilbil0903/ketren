 ...
 */
public class mtvAdapter extends RecyclerView.Adapter<mtvAdapter.ViewHolder> {
	static ArrayList<mtvList> msgList;
	private Context c;
	public mtvAdapter(ArrayList<mtvList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public mtvAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
