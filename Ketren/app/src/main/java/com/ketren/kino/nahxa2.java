...
import com.ketren.kino.Nahxa2.NahxaList2;
...
public class nahxa2 extends Fragment 
{

	private ArrayList<NahxaList2> msgList;
	private NahxaAdapter2 mAdapter;
	private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.nahxa2,container,false);
		...
		show();
		Refresh();
		((PullToRefreshLayout)view.findViewById(R.id.refresh_view2))
	...
	public void Refresh(){
		HttpUtils.httpRequest((Activity)getContext(), "http://bilbil.top/kino.php?type=nahxa2", "POST=ENTER", new Handler() {
				public   void handleMessage(Message msg) {
					try{
						...
						if(s!=null){
							...
							mAdapter = new NahxaAdapter2(msgList,getContext());
							for(int i=0;i<60;i++){
								NahxaList2 msg1 = new NahxaList2(ja.getJSONObject(i).getString("id"),ja.getJSONObject(i).getString("nahxa"),ja.getJSONObject(i).getString("adiris"),ja.getJSONObject(i).getString("nahxiqi"),ja.getJSONObject(i).getString("see"));
								msgList.add(msg1);
							}
