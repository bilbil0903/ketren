 ...
 */
public class kartonAdapter extends RecyclerView.Adapter<kartonAdapter.ViewHolder> {
	static ArrayList<kartonList> msgList;
	private Context c;
	public kartonAdapter(ArrayList<kartonList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public kartonAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
