 ...
 */
public class darisAdapter extends RecyclerView.Adapter<darisAdapter.ViewHolder> {
	static ArrayList<darisList> msgList;
	private Context c;
	public darisAdapter(ArrayList<darisList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public darisAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
