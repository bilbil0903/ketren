...
import com.ketren.kino.nahxa;
import com.ketren.kino.nahxa2;
import java.util.ArrayList;

public class NahxaBaxbat extends Fragment 
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.nahxa_baxbat,container,false);
		viewpager = (ViewPager) view.findViewById(R.id.viewpager);
		rg=(RadioGroup)view.findViewById(R.id.rg2);
