...
public class zongheAdapter extends RecyclerView.Adapter<zongheAdapter.ViewHolder> {
	static ArrayList<zongheList> msgList;
	private Context c;
	public zongheAdapter(ArrayList<zongheList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public zongheAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
