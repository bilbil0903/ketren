 ...
 */
public class kisimlikAdapter extends RecyclerView.Adapter<kisimlikAdapter.ViewHolder> {
	static ArrayList<kisimlikList> msgList;
	private Context c;
	public kisimlikAdapter(ArrayList<kisimlikList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public kisimlikAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
