package com.ketren.kino.Tawsiya;
 ...
 */
public class TawsiyaAdapter extends RecyclerView.Adapter<TawsiyaAdapter.ViewHolder> {
	static ArrayList<TawsiyaList> msgList;
	private Context c;
	public TawsiyaAdapter(ArrayList<TawsiyaList> msgList,Context context){
        this.msgList = msgList;
		this.c=context;
    }
	@Override
	public TawsiyaAdapter.ViewHolder onCreateViewHolder(ViewGroup p1, int p2) {
